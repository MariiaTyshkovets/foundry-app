    ...
    <main className="data-page">
      <section className='theory section'>
        ...
        <p className='text'>
          ...
          <span><b>Q<sub>еф</sub></b> - ефективна теплота кристалізації сплаву, яка враховує виділення акумулювальної теплоти зі зниженням температури сплаву під час кристалізації в інтервалі температур, Дж/кг (розрахункові значення <b>Q<sub>еф</sub></b> деяких ливарних сплавів наведено в таблиці);</span>
          <span><b>&#961;<sub>т-р</sub></b> - густина сплаву, кг/м<sup>3</sup>, у твердо-рідкому стані під час його охолодження в інтервалі кристалізації (знаходять як середнє значення між <b>&#961;<sub>т</sub></b> і <b>&#961;<sub>р</sub></b>);</span>
          <span><b>&#961;<sub>т</sub></b>, <b>&#961;<sub>р</sub></b> - густина сплаву відповідно в твердому і рідкому стані, кг/м<sup>3</sup>;</span>
          <span><b>C<sub>p</sub></b> - теплоємність сплаву в рідкому стану, Дж/(кг*К);</span>
          ...
          <span>Якщо виливок має конфігурацію плити, то <b>&#956; </b>= 1. Для циліндричних виливків та виливків у формі кулі &#956; розраховують за формулою:</span>
        </p>
        ...
        <p className='text' id='secondText'>
          ...
          <span>Для визначення часу охолодження у формі (у секундах) уже затверділого виливка до температури вибивання <b>Т<sub>в</sub></b> Баландін Г.Ф. запропонував такі формули:</span>
        </p>
        <div className='image formulas'>
        ...
        <p className='text' id='thirdText'>
          ...
          <span><b>n</b> - показник ступеня параболи, якою описується температурне поле у формі; <b>n</b> = 2...3 (найчастіше має значення 2.75).</span>
        </p>
      </section>
